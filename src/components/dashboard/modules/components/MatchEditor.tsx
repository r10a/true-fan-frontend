import { CardHeader, Checkbox, FormControl, FormControlLabel, FormLabel, IconButton, Radio, RadioGroup } from '@material-ui/core';
...
export default function MatchEditor(props: IMatchEditorProps) {
    ...
    const {
        updateMatchHandler,
        tournament,
        match: { left, right, start, completed: matchCompleted, mom: matchMom, winner, end },
        index
    } = props;
                    ...
                    <Grid item container alignItems="center">
                        <Grid item xs={12} md>
                            <FormControl fullWidth>
                                ...
                                >
                                    <FormControlLabel value={left} control={<Radio />} label={left} labelPlacement="start" />
                                    <FormControlLabel value={right} control={<Radio />} label={right} labelPlacement="end" />
                                    <FormControlLabel
                                        value={""}
                                        control={
                                            <IconButton
                                                onClick={_clearWinnerHandler}
                                            >
                                                <HighlightOffIcon />
                                            </IconButton>
                                        }
